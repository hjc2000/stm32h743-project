...
char const *pf_cmina_get_file_directory(pnet_t const *net)
{
	return net->fspm_cfg.file_directory;
}

void pf_cmina_get_station_name(pnet_t const *net, char *station_name)
{
	snprintf(
		station_name,
...
pnal_ipaddr_t pf_cmina_get_ipaddr(pnet_t const *net)
{
	return net->cmina_current_dcp_ase.full_ip_suite.ip_suite.ip_addr;
}

pnal_ipaddr_t pf_cmina_get_netmask(pnet_t const *net)
{
	return net->cmina_current_dcp_ase.full_ip_suite.ip_suite.ip_mask;
}

pnal_ipaddr_t pf_cmina_get_gateway(pnet_t const *net)
{
	return net->cmina_current_dcp_ase.full_ip_suite.ip_suite.ip_gateway;
}

pnet_ethaddr_t const *pf_cmina_get_device_macaddr(pnet_t const *net)
{
...
int pf_cmina_remove_all_data_files(char const *file_directory)
{
 ...
 * @return  a string representation of the CMINA state.
 */
static char const *pf_cmina_state_to_string(pnet_t *net)
{
...
bool pf_cmina_is_stationname_valid(char const *station_name, uint16_t len)
{
	uint16_t i;
 ...
 */
bool pf_cmina_is_ipsuite_valid(pf_ip_suite_t const *p_ipsuite)
{
 ...
 *          -1 if the IP suite is invalid
 */
bool pf_cmina_is_full_ipsuite_valid(pf_full_ip_suite_t const *p_full_ipsuite)
{
