 ...
 * @return  A string representation of the CMPBE state.
 */
static char const *pf_cmpbe_state_to_string(pf_cmpbe_state_values_t state)
{
...
void pf_cmpbe_show(pf_ar_t const *p_ar)
{
	char const *s = pf_cmpbe_state_to_string(p_ar->cmpbe_state);
...
int pf_cmpbe_rm_ccontrol_cnf(
	pf_ar_t *p_ar,
	pf_control_block_t const *p_control_io,
	pnet_result_t *p_result)
{
	int ret = -1;
