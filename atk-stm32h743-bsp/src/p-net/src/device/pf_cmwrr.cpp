 ...
 */
static char const *pf_cmwrr_state_to_string(pf_cmwrr_state_values_t state)
{
...
void pf_cmwrr_show(pnet_t const *net, pf_ar_t const *p_ar)
{
	char const *s = pf_cmwrr_state_to_string(p_ar->cmwrr_state);
