...
extern "C"
{
	 ...
	 */
	uint8_t pf_port_get_number_of_ports(pnet_t const *net);
	 ...
	 */
	void pf_port_get_list_of_ports(pnet_t const *net, pf_lldp_port_list_t *p_list);
	 ...
	 */
	bool pf_port_subslot_is_dap_port_id(pnet_t const *net, uint16_t subslot);
	 ...
	 */
	pnet_port_cfg_t const *pf_port_get_config(pnet_t *net, int loc_port_num);
	 ...
	 *          false if not
	 */
	bool pf_port_is_valid(pnet_t const *net, int loc_port_num);
