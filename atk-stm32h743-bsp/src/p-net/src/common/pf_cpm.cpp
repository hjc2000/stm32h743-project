 ...
 */
static char const *pf_cpm_state_to_string(pf_cpm_state_values_t state)
{
...
int pf_cpm_check_src_addr(pf_cpm_t const *p_cpm, pnal_buf_t const *p_buf)
{
	int ret = -1;
...
int pf_cpm_get_data_status(pf_cpm_t const *p_cpm, uint8_t *p_data_status)
{
...
void pf_cpm_show(pnet_t const *net, pf_cpm_t const *p_cpm)
{
	printf("cpm:\n");
